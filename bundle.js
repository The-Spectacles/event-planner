...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventEvents = __webpack_require__(29);
	var rsvpEvents = __webpack_require__(40);
	var profileEvents = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- sign up, sign in, title,  greeting?, shows background image -->\n\n<h3>Put your event plans into digital action with Happening, an event creation tool to help manage correspondence with ease.\nWhether it's a donut party with co-workers or your wedding day, no event is too small to <span>make it a Happening</span>. </h3>\n\n<a class=\"sign-in\" role=\"button\" href=\"\">Sign in.</a>\n<a class=\"sign-up\" role=\"button\" href=\"\">Sign up.</a>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(24);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(signUpData).done(function (data, textStatus, jqXHR) {
	    api.signIn(data, textStatus, jqXHR, signUpData).done(ui.signInSuccess).fail(ui.failure);
	  }).fail(ui.failure);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).done(ui.passwordChangeSuccess).fail(ui.failure);
	};
	...
	var onTogglePasswordForm = function onTogglePasswordForm(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showAuthForms = function showAuthForms(authForm) {
	  if (authForm === 'sign-up') {
	    var signUpForm = __webpack_require__(47);
	    $('.interface').html(signUpForm);
	  } else if (authForm === 'sign-in') {
	    var signInForm = __webpack_require__(48);
	...
	var togglePasswordForm = function togglePasswordForm() {
	  var passwordVisible = $('.interface').children('.pwd-form').length;
	  if (passwordVisible) {
	    profileEvents.buildProfile();
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rsvps = __webpack_require__(40);

	var renderProfile = __webpack_require__(46);

	var buildProfile = function buildProfile() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(24);
	var formatDateTime = __webpack_require__(30);
	...
	var getAllEvents = function getAllEvents() {
	  event.preventDefault();
	  api.getAllEvents().done(ui.allEventsSuccess).fail(ui.failure);
	};

	// getting all events (profile)
	var getMyEvents = function getMyEvents() {
	  event.preventDefault();
	  api.getMyEvents().done(ui.myEventsSuccess).fail(ui.failure);
	};

	// show one event
	var showSingleEvent = function showSingleEvent(event) {
	  event.preventDefault();
	  var eventId = $(event.target).attr('data-id');
	  api.getOneEvent(eventId).done(ui.singleEventSuccess).fail(ui.failure);
	};

	// show event create form
	var showEventForm = function showEventForm(event) {
	  event.preventDefault();
	...
	var createEvent = function createEvent(event) {
	  ...
	  api.createNewEvent(data).done(ui.createEventSuccess).fail(ui.failure);
	};

	// show the edit form
	var getEditForm = function getEditForm(event) {
	  event.preventDefault();
	  var eventId = $(event.target).attr('data-id');
	  api.getOneEvent(eventId).done(ui.editFormSuccess).fail(ui.failure);
	};
	...
	var updateEvent = function updateEvent(event) {
	  ...
	  var data = getFormFields(event.target);
	  data.event = formatDateTime.formatTimeForMongo(data.event);
	  api.updateEvent(data).done(ui.singleEventSuccess).fail(ui.failure);
	};

	var deleteEvent = function deleteEvent(event) {
	  event.preventDefault();
	  var eventId = $(event.target).attr('data-id');
	  api.deleteEvent(eventId).done(function () {
...
/***/ function(module, exports) {
	...
	var formatDatesForDisplay = function formatDatesForDisplay(data) {
	...
	var formatTimeForMongo = function formatTimeForMongo(event) {
	...
	var convertClock = function convertClock(time) {
	  ...
	  if (time.substring(0, 2) < 12) {
	    // console.log('time is', parseInt(time.substring(0,2), 10));
	    if (parseInt(time.substring(0, 2), 10) < 1) {
	    ...
	    // get the hour
	    var oldHour = time.substring(0, 2);

	    // subtract 12 from the hour so '17' becomes '5'
	    var newHour = parseInt(oldHour, 10) - 12;
	...
	var trimDateAndTime = function trimDateAndTime(event) {
	...
	module.exports = {
	  formatDatesForDisplay: formatDatesForDisplay,
	  formatTimeForMongo: formatTimeForMongo,
	  convertClock: convertClock,
	  trimDateAndTime: trimDateAndTime
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showAllEventsTemplate = __webpack_require__(33);
	var showSingleEventTemplate = __webpack_require__(35);
	var showEditFormTemplate = __webpack_require__(36);
	var showMyEventsTemplate = __webpack_require__(37);
	var showRsvpViewTemplate = __webpack_require__(38);
	var showCreateEventTemplate = __webpack_require__(39);

	// for getting all events
	var allEventsSuccess = function allEventsSuccess(data) {
	...
	var singleEventSuccess = function singleEventSuccess(data) {
	  ...
	  if (data.event.rsvps) {
	    ...
	    data.event.rsvps.forEach(function (rsvp) {
	...
	//show event create form
	var showEventFormSuccess = function showEventFormSuccess() {
	  $(".interface").html(showCreateEventTemplate());
	};

	// for getting my events

	var myEventsSuccess = function myEventsSuccess(data) {
	  data.events = formatDateTime.formatDatesForDisplay(data.events);
	  var myEvents = data;
	...
	// show edit form
	var editFormSuccess = function editFormSuccess(data) {
	  data.event = formatDateTime.trimDateAndTime(data.event);
	  var event = data.event;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1 class=\"event-title\">RSVP to an Event</h1>\n\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"events-partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<p><a href=\"\" class='event-box show-event' data-id='"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<p>Starts: "
	    + container.escapeExpression(((helper = (helper = helpers.startTime || (depth0 != null ? depth0.startTime : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"startTime","hash":{},"data":data}) : helper)))
	    + "</p>\n";
	  ...
	  return "<a href=\"\" class=\"update-event\"data-id='"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "'>Edit</a>\n<a href=\"\" class=\"delete-event\"data-id='"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "'>Delete</a>\n\n<h2 class=\"event-name\">"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "</h2>\n<p>Date: "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"events-partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"3":function(container,depth0,helpers,partials,data) {
	    return "\n<div class=\"prompt\">\n  <p>Looks like you don't have any events yet.</p>\n  <p>Why don't you <a href=\"\" class=\"show-event-form\">create one</a>?</p>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h1 class=\"event-title\">My Events</h1>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.events : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2>"
	    ...
	    + "</h2>\n<input type=\"hidden\" id=\"rsvp[questions][text]\" name=\"rsvp[questions][text]\" value=\""
	    + alias4(((helper = (helper = helpers.text || (depth0 != null ? depth0.text : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"text","hash":{},"data":data}) : helper)))
	    + "\">\n"
	  ...
	  return "<div>\n<label>\n<input type=\"radio\" name=\"rsvp[questions][options]\" value=\""
	  ...
	  return "  <h3>"
	    + container.escapeExpression(((helper = (helper = helpers.key || (data && data.key)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "</h3>\n"
	    + ((stack1 = helpers.each.call(alias1,depth0,{"name":"each","hash":{},"fn":container.program(11, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"11":function(container,depth0,helpers,partials,data) {
	    var stack1;
	  ...
	  return "\n<h2 class=\"event-name\">"
	    ...
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.startTime : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.startTime : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n<form id=\"create-rsvp\" class=\"create-rsvp\">\n<input type=\"hidden\" id=\"rsvp[_event]\" name=\"rsvp[_event]\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.questions : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "<button type=\"submit\" class=\"btn btn-default\">RSVP!</button>\n</form>\n\n<h2>RSVPs so far</h2>\n<div class=\"event-rsvps\">\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.responses : depth0),{"name":"each","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMyRsvps = function getMyRsvps() {
	  event.preventDefault();
	  api.getMyRsvps().done(ui.myRsvpsSuccess).fail(ui.failure);
	};

	var onCreateRsvp = function onCreateRsvp(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var questionsArray = [];
	  questionsArray.push(data.rsvp.questions);
	  data.rsvp.questions = questionsArray;
	  api.createRsvp(data).done(function () {
	...
	var onShowRsvp = function onShowRsvp(event) {
	  event.preventDefault();
	  var rsvpId = $(event.target).attr('data-id');
	  api.getOneRsvp(rsvpId).done(ui.singleRsvpSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// show an rsvp
	var getOneRsvp = function getOneRsvp(rsvpId) {
	  return $.ajax({
	...
	// create an rsvp
	var createRsvp = function createRsvp(data) {
	  return $.ajax({
	    url: app.host + '/rsvps',
	    method: 'POST',
	    headers: {
	...
	// edit an rsvp
	var updateRsvp = function updateRsvp(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myRsvpsTemplate = __webpack_require__(43);
	var singleRsvpTemplate = __webpack_require__(45);

	var myRsvpsSuccess = function myRsvpsSuccess(data) {
	  data.rsvps = formatDateTime.formatDatesForDisplay(data.rsvps);
	  $('.my-rsvps').html(myRsvpsTemplate(data));
	};

	var singleRsvpSuccess = function singleRsvpSuccess(data) {
	...
	var createRsvpSuccess = function createRsvpSuccess() {
	...
	module.exports = {
	  createRsvpSuccess: createRsvpSuccess,
	  myRsvpsSuccess: myRsvpsSuccess,
	  singleRsvpSuccess: singleRsvpSuccess,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(44),depth0,{"name":"rsvps-partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"3":function(container,depth0,helpers,partials,data) {
	    return "\n<div class=\"prompt\">\n  <p>Looks like you haven't RSVP-ed to any events yet.</p>\n  <p>Why don't you <a class=\"get-all-events\">find an event</a>?</p>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h1 class=\"event-title\">My Rsvps</h1>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.rsvps : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n\n";
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<p><a href=\"\" class='event-box show-rsvp' data-id='"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "'>\n"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\n"
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.rsvps : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<a href=\"\" class=\"update-rsvp\" data-id='"
	    + alias4(((helper = (helper = helpers._event || (depth0 != null ? depth0._event : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_event","hash":{},"data":data}) : helper)))
	    + "'>Edit</a>\n\n\n<h2 class=\"event-name\">"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "</h2>\n<p>Date: "
	    + alias4(((helper = (helper = helpers.date || (depth0 != null ? depth0.date : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"date","hash":{},"data":data}) : helper)))
	    ...
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.description : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.startTime : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.endTime : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.questions : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"events-list\"></div>\n<div class=\"my-rsvps\"></div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"wrapper\">\n  <h1 class=\"auth-form\">Sign Up</h1>\n  <form id=\"sign-up\">\n    <div>\n      <label class=\"auth-form\" for=\"credentials[email]\">Email</label>\n      <input name=\"credentials[email]\" id=\"credentials[email]\" type=\"email\" placeholder=\"Email\" required>\n    </div>\n    <div>\n      <label class=\"auth-form\" for=\"credentials[username]\">Username</label>\n      <input name=\"credentials[username]\" id=\"credentials[username]\" type=\"username\" placeholder=\"Username\" required>\n    </div>\n    <div>\n      <label class=\"auth-form\" for=\"credentials[password]\">Password</label>\n      <input name=\"credentials[password]\" id=\"credentials[password]\" type=\"password\" placeholder=\"Password\" required>\n    </div>\n    <div>\n      <label class=\"auth-form\" for=\"credentials[password_confirmation]\">Confirm password</label>\n      <input name=\"credentials[password_confirmation]\" id=\"credentials[password_confirmation]\" type=\"password\" placeholder=\"Confirm password\" required>\n    </div>\n    <p><button type=\"submit\" class=\"btn btn-default\">Sign Up</button></p>\n  </form>\n\n  <p class=\"auth-form\">Have an account? <a class=\"sign-in\" role=\"button\" href=\"\">Sign in.</a></p>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"wrapper\">\n  <h1 class=\"auth-form\">Sign In</h1>\n  <form id=\"sign-in\">\n    <div>\n      <label class=\"auth-form\" for=\"credentials[email]\">Email</label>\n      <input name=\"credentials[email]\" id=\"credentials[email]\" type=\"email\" placeholder=\"Email\" required>\n    </div>\n    <div>\n      <label class=\"auth-form\" for=\"credentials[password]\">Password</label>\n      <input name=\"credentials[password]\" id=\"credentials[password]\" type=\"password\" placeholder=\"Password\" required>\n    </div>\n    <p><button type=\"submit\" class=\"btn btn-default\">Sign In</button></p>\n  </form>\n\n  <p class=\"auth-form\" >No account? <a class=\"sign-up\" role=\"button\" href=\"\">Sign up.</a></p>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "57529177559efaeff664a5aa4831d136.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(24);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
